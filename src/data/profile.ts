...
export const labels = {
  fr: {
    ...
    quickProfile: "Profil en 60 secondes",
    downloadResume: "Obtenir le CV en PDF",
    contactMe: "Me contacter",
    impactEyebrow: "En chiffres",
    impactTitle: "Ce que ça a changé",
    featuredWork: "Études de cas",
    featuredWorkTitle: "Trois projets qui résument ma façon de construire",
    featuredWorkIntro:
      "Trois démonstrations phares pour comprendre rapidement mon approche : système métier, automatisation reproductible et laboratoire interactif.",
    additionalWorkEyebrow: "Portfolio complet",
    additionalWorkTitle: "D’autres systèmes, du terrain à l’architecture",
    additionalWorkIntro:
      "Cinq études de cas complémentaires documentent le portail client, le soutien TI, l’analyse média, l’IA appliquée et la conception d’architecture.",
  ...
  en: {
    ...
    quickProfile: "60-second profile",
    downloadResume: "Get the résumé as PDF",
    contactMe: "Contact me",
    impactEyebrow: "In numbers",
    impactTitle: "What actually changed",
    featuredWork: "Case studies",
    featuredWorkTitle: "Three projects that summarize how I build",
    featuredWorkIntro:
      "Three flagship demonstrations for a fast view of my approach: a business system, a reproducible automation pipeline, and an interactive laboratory.",
    additionalWorkEyebrow: "Complete portfolio",
    additionalWorkTitle: "More systems, from field work to architecture",
    additionalWorkIntro:
      "Five complementary case studies cover the client portal, IT support, media analysis, applied AI, and architecture design.",
